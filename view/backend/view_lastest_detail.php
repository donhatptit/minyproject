		...
		<div class="container-left">
			...
			<div class="subject">
				<div class="title-content">
					...
					<div class="view-all"><a href="">Quay lại<img src="public/frontend/images/trang-chu/icon-view-all.png"></a></div>
				</div>
			...
			<div class="page_link1" style="text-align: center; margin-bottom: 15px;">
				...
				for( $i =1 ; $i <= $num_page ; $i++):
					...
					<div class="next_page">
						...
						?>
					><a href="index.php?controller=subject&p=<?php echo $i; ?>&id=<?php echo $id; ?>">
						<?php echo $i; ?>
					</a></div>
				<?php endfor; ?>
			</div>
